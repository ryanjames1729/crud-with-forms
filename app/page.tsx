        ...
        { create && (
          <form className="flex flex-col items-center justify-center">
            <label htmlFor="create" className="flex flex-col items-center justify-center">
              ...
              <input type="text" name="createName" id="createName" placeholder="Create Name goes here" className="w-96 h-12 p-4 mt-4 border border-gray-300 rounded-lg dark:border-gray-700"/>
              <input type="text" name="createScore" id="createScore" placeholder="Create Score goes here" className="w-96 h-12 p-4 mt-4 border border-gray-300 rounded-lg dark:border-gray-700"/>
        ...
        { update && (
          <form className="flex flex-col items-center justify-center">
            <label htmlFor="create" className="flex flex-col items-center justify-center">
              ...
              <input type="text" name="updateName" id="updateName" placeholder="Update Name goes here" className="w-96 h-12 p-4 mt-4 border border-gray-300 rounded-lg dark:border-gray-700"/>
              <input type="text" name="updateScore" id="updateScore" placeholder="Update Score goes here" className="w-96 h-12 p-4 mt-4 border border-gray-300 rounded-lg dark:border-gray-700"/>
